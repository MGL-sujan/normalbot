  ...
  if(args[1]) {
    ...
    request(url ,function(err,response,body) {
      if(err) {console.log(err)}
        ...
        .setTitle("Weather")
        .setDescription(`${weather.name},${weather.sys.country}`,true)
        .addField("Temperature",weather.main.temp)
        .addField("Weather",weather.weather[0].main.toLowerCase(),true)
        .setColor('#3700ff')
        .addField("Feels Like", weather.main.feels_like,true)
        .addField("Max. Today", weather.main.temp_max,true)
        .addField("Min. Today", weather.main.temp_min,true)
        .addField("Pressure", weather.main.pressure,true)
        .addField("Description", weather.weather[0].description,true)
    ...
    request(url ,function(err,response,body) {
      if(err) {console.log(err)}
        ...
        let embed = new MessageEmbed()
        .setTitle("Weather")
        .addField("Temperature",weather.main.temp,true)
        .addField("Weather",weather.weather[0].main.toLowerCase(),true)
        .setDescription(`${weather.name},${weather.sys.country}`,true)
        .setColor('#3700ff')
        .addField("Feels Like", weather.main.feels_like,true)
